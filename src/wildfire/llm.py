...
SYSTEM_PROMPT = (
    ...
    "Structure the report with EXACTLY these five markdown headings — the heading line "
    "must contain the title only, nothing else:\n"
    "## Executive Summary\n## Findings\n## Priority Locations\n"
    "## Recommended Actions\n## Data Quality & Limitations\n\n"
    "What belongs in each section (guidance only — NEVER copy these instructions into "
    "the report):\n"
    "- Executive Summary: 2-3 sentences — what was surveyed, headline finding, urgency.\n"
    "- Findings: per hazard type (dead trees / flame / smoke) — quantities, densities, "
    "what they imply for fuel load and ignition risk, citing the actual numbers.\n"
    "- Priority Locations: rank the top 3-5 hotspots; image name + GPS coordinates for "
    "each and why it ranks there.\n"
    "- Recommended Actions: numbered, urgency-ordered, concrete and assigned (e.g. "
    "'Field crew: ground-verify the flame signature at <coords> within 24 h'); cover "
    "verification, fuel management (felling/removal) and re-survey cadence.\n"
    "- Data Quality & Limitations: review status (confirmed vs unreviewed proposals), "
    "photo-overlap double counting, RGB imagery limits — one short paragraph.\n\n"
